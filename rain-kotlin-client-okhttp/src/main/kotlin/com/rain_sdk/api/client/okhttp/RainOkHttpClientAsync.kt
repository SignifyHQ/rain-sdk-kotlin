...
package com.rain_sdk.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.rain_sdk.api.client.RainClientAsync
import com.rain_sdk.api.client.RainClientAsyncImpl
...
import com.rain_sdk.api.core.http.HttpClient
...
/**
 * A class that allows building an instance of [RainClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class RainOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [RainClientAsync]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): RainClientAsync = builder().fromEnv().build()
    }

    /** A builder for [RainOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.rain_sdk.api.core.jsonMapper]. The default is usually sufficient and
        ...
        /**
         * Returns an immutable instance of [RainClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RainClientAsync =
            RainClientAsyncImpl(
                clientOptions
                    .httpClient(
