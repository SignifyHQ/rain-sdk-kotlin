...
/**
 * A class that allows building an instance of [RainClient] with [OkHttpClient] as the underlying
 * [HttpClient].
 */
class RainOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [RainClient]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): RainClient = builder().fromEnv().build()
    }

    /** A builder for [RainOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [RainClient].
         *
