...
dependencies {
    testImplementation(project(":rain-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../rain-kotlin-core/src/main/resources/META-INF/proguard/rain-kotlin-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.rain_sdk.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../rain-kotlin-core/src/main/resources/META-INF/proguard/rain-kotlin-core.pro",
