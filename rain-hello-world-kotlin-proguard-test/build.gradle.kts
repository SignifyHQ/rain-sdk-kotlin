...
dependencies {
    testImplementation(project(":rain-hello-world-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../rain-hello-world-kotlin-core/src/main/resources/META-INF/proguard/rain-hello-world-kotlin-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.rain_hello_world.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../rain-hello-world-kotlin-core/src/main/resources/META-INF/proguard/rain-hello-world-kotlin-core.pro",
