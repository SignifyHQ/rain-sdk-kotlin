...
package com.rain_hello_world.api.core

import com.fasterxml.jackson.databind.json.JsonMapper
import com.rain_hello_world.api.core.http.Headers
import com.rain_hello_world.api.core.http.HttpClient
import com.rain_hello_world.api.core.http.PhantomReachableClosingHttpClient
import com.rain_hello_world.api.core.http.QueryParams
import com.rain_hello_world.api.core.http.RetryingHttpClient
...
private constructor(
     ...
     *
     * Use the one published in `rain-hello-world-kotlin-client-okhttp` or implement your own.
     *
     ...
     *
     * Defaults to [com.rain_hello_world.api.core.jsonMapper]. The default is usually sufficient and
    ...
    class Builder internal constructor() {
         ...
         */
        fun fromEnv() = apply {
            (System.getProperty("rainhelloworld.baseUrl")
                    ?: System.getenv("RAIN_HELLO_WORLD_BASE_URL"))
                ?.let { baseUrl(it) }
            (System.getProperty("rainhelloworld.apiKey")
                    ?: System.getenv("RAIN_HELLO_WORLD_API_KEY"))
                ?.let { apiKey(it) }
        }
