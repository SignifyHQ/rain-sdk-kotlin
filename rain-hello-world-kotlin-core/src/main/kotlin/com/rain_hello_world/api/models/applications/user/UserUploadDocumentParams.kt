 ...
 * additional verification documents such as IDs, utility bills, and other required legal documents.
 */
class UserUploadDocumentParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UserUploadDocumentParams].
         *
    ...
    /** A builder for [UserUploadDocumentParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(userUploadDocumentParams: UserUploadDocumentParams) = apply {
            userId = userUploadDocumentParams.userId
            body = userUploadDocumentParams.body.toBuilder()
            additionalHeaders = userUploadDocumentParams.additionalHeaders.toBuilder()
            additionalQueryParams = userUploadDocumentParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [UserUploadDocumentParams].
         *
         ...
         */
        fun build(): UserUploadDocumentParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserUploadDocumentParams &&
            userId == other.userId &&
            body == other.body &&
    ...
    override fun toString() =
        "UserUploadDocumentParams{userId=$userId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
