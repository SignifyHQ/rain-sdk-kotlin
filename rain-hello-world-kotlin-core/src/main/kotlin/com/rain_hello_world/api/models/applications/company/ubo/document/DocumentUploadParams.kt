...
package com.rain_hello_world.api.models.applications.company.ubo.document
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(documentUploadParams: DocumentUploadParams) = apply {
            ...
            uboId = documentUploadParams.uboId
    ...
    private constructor(
        ...
        private val hashCode: Int by lazy {
            Objects.hash(document, country, side, type, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{document=$document, country=$country, side=$side, type=$type, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "DocumentUploadParams{companyId=$companyId, uboId=$uboId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
