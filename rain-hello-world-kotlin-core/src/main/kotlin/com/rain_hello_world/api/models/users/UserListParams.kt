...
/**
 * This endpoint retrieves all users associated with a specific company. The response will return a
 * list of users, including their personal and contact details.
 */
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(userListParams: UserListParams) = apply {
            companyId = userListParams.companyId
    ...
    override fun hashCode(): Int =
        Objects.hash(companyId, cursor, limit, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "UserListParams{companyId=$companyId, cursor=$cursor, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
