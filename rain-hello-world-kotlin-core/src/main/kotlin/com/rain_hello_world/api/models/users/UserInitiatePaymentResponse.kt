...
class UserInitiatePaymentResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UserInitiatePaymentResponse].
         *
    ...
    /** A builder for [UserInitiatePaymentResponse]. */
    class Builder internal constructor() {

        private var address: JsonField<String>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(userInitiatePaymentResponse: UserInitiatePaymentResponse) = apply {
            address = userInitiatePaymentResponse.address
            additionalProperties = userInitiatePaymentResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UserInitiatePaymentResponse].
         *
         ...
         */
        fun build(): UserInitiatePaymentResponse =
    ...
    fun validate(): UserInitiatePaymentResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserInitiatePaymentResponse &&
    ...
    override fun toString() =
        "UserInitiatePaymentResponse{address=$address, additionalProperties=$additionalProperties}"
}
