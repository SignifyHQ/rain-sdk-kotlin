...
package com.rain_hello_world.api.models.contracts
...
private constructor(
    ...
    companion object {
        ...
        fun none(): ContractListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        fun build(): ContractListParams =
            ContractListParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "ContractListParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
