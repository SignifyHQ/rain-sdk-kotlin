...
package com.rain_hello_world.api.models.companies.signatures
...
private constructor(
    ...
    private val isAmountNative: Boolean?,
    ...
    /**
     * Indicates whether the amount is in the asset's native units. If false, the amount is
     * expressed in cents.
     */
    fun isAmountNative(): Boolean? = isAmountNative
    ...
    class Builder internal constructor() {
        ...
        private var isAmountNative: Boolean? = null
        ...
        internal fun from(
            ...
            companyId = signatureRetrieveWithdrawalSignatureParams.companyId
            ...
            isAmountNative = signatureRetrieveWithdrawalSignatureParams.isAmountNative
            additionalHeaders =
         ...
         * expressed in cents.
         */
        fun isAmountNative(isAmountNative: Boolean?) = apply {
            this.isAmountNative = isAmountNative
        }

        /**
         * Alias for [Builder.isAmountNative].
         *
         * This unboxed primitive overload exists for backwards compatibility.
         */
        fun isAmountNative(isAmountNative: Boolean) = isAmountNative(isAmountNative as Boolean?)
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                ...
                isAmountNative?.let { put("isAmountNative", it.toString()) }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SignatureRetrieveWithdrawalSignatureParams &&
            ...
            isAmountNative == other.isAmountNative &&
    ...
    override fun toString() =
        "SignatureRetrieveWithdrawalSignatureParams{companyId=$companyId, token=$token, adminAddress=$adminAddress, amount=$amount, recipientAddress=$recipientAddress, chainId=$chainId, isAmountNative=$isAmountNative, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
