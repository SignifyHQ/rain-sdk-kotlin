...
import com.rain_hello_world.api.services.blocking.ApplicationService
import com.rain_hello_world.api.services.blocking.ApplicationServiceImpl
import com.rain_hello_world.api.services.blocking.BalanceService
import com.rain_hello_world.api.services.blocking.BalanceServiceImpl
import com.rain_hello_world.api.services.blocking.CardService
import com.rain_hello_world.api.services.blocking.CardServiceImpl
import com.rain_hello_world.api.services.blocking.CompanyService
import com.rain_hello_world.api.services.blocking.CompanyServiceImpl
import com.rain_hello_world.api.services.blocking.ContractService
import com.rain_hello_world.api.services.blocking.ContractServiceImpl
import com.rain_hello_world.api.services.blocking.DisputeService
import com.rain_hello_world.api.services.blocking.DisputeServiceImpl
import com.rain_hello_world.api.services.blocking.KeyService
import com.rain_hello_world.api.services.blocking.KeyServiceImpl
import com.rain_hello_world.api.services.blocking.PaymentService
import com.rain_hello_world.api.services.blocking.PaymentServiceImpl
import com.rain_hello_world.api.services.blocking.SignatureService
import com.rain_hello_world.api.services.blocking.SignatureServiceImpl
import com.rain_hello_world.api.services.blocking.TransactionService
import com.rain_hello_world.api.services.blocking.TransactionServiceImpl
import com.rain_hello_world.api.services.blocking.UserService
import com.rain_hello_world.api.services.blocking.UserServiceImpl

class RainHelloWorldClientImpl(private val clientOptions: ClientOptions) : RainHelloWorldClient {
    ...
    private val async: RainHelloWorldClientAsync by lazy {
        RainHelloWorldClientAsyncImpl(clientOptions)
    }

    private val withRawResponse: RainHelloWorldClient.WithRawResponse by lazy {
    ...
    override fun async(): RainHelloWorldClientAsync = async

    override fun withRawResponse(): RainHelloWorldClient.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): RainHelloWorldClient =
        RainHelloWorldClientImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        RainHelloWorldClient.WithRawResponse {
        ...
        override fun withOptions(
            ...
            RainHelloWorldClientImpl.WithRawResponseImpl(
