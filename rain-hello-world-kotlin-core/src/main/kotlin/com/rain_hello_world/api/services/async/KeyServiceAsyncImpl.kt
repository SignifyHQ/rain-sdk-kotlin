...
import com.rain_hello_world.api.models.keys.KeyCreateResponse
import com.rain_hello_world.api.models.keys.KeyDeleteParams
...
class KeyServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override suspend fun delete(params: KeyDeleteParams, requestOptions: RequestOptions) {
        // delete /keys/{keyId}
