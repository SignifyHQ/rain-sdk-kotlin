...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.rain_hello_world.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.rain_hello_world.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.rain_hello_world.api.** {
    <init>(...);
