...
import com.rain_sdk.api.services.async.ApplicationServiceAsync
import com.rain_sdk.api.services.async.ApplicationServiceAsyncImpl
import com.rain_sdk.api.services.async.BalanceServiceAsync
import com.rain_sdk.api.services.async.BalanceServiceAsyncImpl
import com.rain_sdk.api.services.async.CardServiceAsync
import com.rain_sdk.api.services.async.CardServiceAsyncImpl
import com.rain_sdk.api.services.async.CompanyServiceAsync
import com.rain_sdk.api.services.async.CompanyServiceAsyncImpl
import com.rain_sdk.api.services.async.ContractServiceAsync
import com.rain_sdk.api.services.async.ContractServiceAsyncImpl
import com.rain_sdk.api.services.async.DisputeServiceAsync
import com.rain_sdk.api.services.async.DisputeServiceAsyncImpl
import com.rain_sdk.api.services.async.KeyServiceAsync
import com.rain_sdk.api.services.async.KeyServiceAsyncImpl
import com.rain_sdk.api.services.async.PaymentServiceAsync
import com.rain_sdk.api.services.async.PaymentServiceAsyncImpl
import com.rain_sdk.api.services.async.SignatureServiceAsync
import com.rain_sdk.api.services.async.SignatureServiceAsyncImpl
import com.rain_sdk.api.services.async.TransactionServiceAsync
import com.rain_sdk.api.services.async.TransactionServiceAsyncImpl
import com.rain_sdk.api.services.async.UserServiceAsync
import com.rain_sdk.api.services.async.UserServiceAsyncImpl

class RainClientAsyncImpl(private val clientOptions: ClientOptions) : RainClientAsync {
    ...
    private val sync: RainClient by lazy { RainClientImpl(clientOptions) }

    private val withRawResponse: RainClientAsync.WithRawResponse by lazy {
    ...
    override fun sync(): RainClient = sync

    override fun withRawResponse(): RainClientAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): RainClientAsync =
        RainClientAsyncImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        RainClientAsync.WithRawResponse {
        ...
        override fun withOptions(
            ...
            RainClientAsyncImpl.WithRawResponseImpl(
