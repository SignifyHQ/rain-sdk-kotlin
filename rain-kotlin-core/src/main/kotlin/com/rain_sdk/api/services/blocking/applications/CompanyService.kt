...
import com.rain_sdk.api.models.applications.company.CompanyRetrieveParams
import com.rain_sdk.api.models.applications.company.CompanyRetrieveResponse
...
import com.rain_sdk.api.services.blocking.applications.company.UboService
...
interface CompanyService {
    ...
    /** @see retrieve */
    fun retrieve(companyId: String, requestOptions: RequestOptions): CompanyRetrieveResponse =
    ...
    interface WithRawResponse {
         ...
         * the same as [CompanyService.retrieve].
         */
        @MustBeClosed
        fun retrieve(
            companyId: String,
         ...
         * otherwise the same as [CompanyService.update].
         */
        @MustBeClosed
        fun update(
            companyId: String,
         ...
         * otherwise the same as [CompanyService.reapply].
         */
        @Deprecated("deprecated")
        @MustBeClosed
        fun reapply(
         ...
         * otherwise the same as [CompanyService.uploadDocument].
         */
        @MustBeClosed
        fun uploadDocument(
            companyId: String,
