...
class EvidenceServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    EvidenceServiceAsync {

    private val withRawResponse: EvidenceServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): EvidenceServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): EvidenceServiceAsync =
        EvidenceServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    override suspend fun upload(params: EvidenceUploadParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            EvidenceServiceAsyncImpl.WithRawResponseImpl(
