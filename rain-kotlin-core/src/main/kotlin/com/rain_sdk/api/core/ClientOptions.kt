...
package com.rain_sdk.api.core

import com.fasterxml.jackson.databind.json.JsonMapper
import com.rain_sdk.api.core.http.Headers
import com.rain_sdk.api.core.http.HttpClient
import com.rain_sdk.api.core.http.LoggingHttpClient
import com.rain_sdk.api.core.http.PhantomReachableClosingHttpClient
import com.rain_sdk.api.core.http.QueryParams
import com.rain_sdk.api.core.http.RetryingHttpClient
...
private constructor(
     ...
     *
     * Use the one published in `rain-kotlin-client-okhttp` or implement your own.
     *
     ...
     *
     * Defaults to [com.rain_sdk.api.core.jsonMapper]. The default is usually sufficient and rarely
    ...
    class Builder internal constructor() {
        ...
        fun fromEnv() = apply {
            ...
            (System.getProperty("rain.baseUrl") ?: System.getenv("RAIN_BASE_URL"))?.let {
                baseUrl(it)
            }
