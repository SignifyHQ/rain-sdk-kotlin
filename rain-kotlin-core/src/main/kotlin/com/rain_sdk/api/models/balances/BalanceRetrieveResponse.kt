...
package com.rain_sdk.api.models.balances
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(balanceRetrieveResponse: BalanceRetrieveResponse) = apply {
            balanceDue = balanceRetrieveResponse.balanceDue
            creditLimit = balanceRetrieveResponse.creditLimit
            pendingCharges = balanceRetrieveResponse.pendingCharges
            postedCharges = balanceRetrieveResponse.postedCharges
            spendingPower = balanceRetrieveResponse.spendingPower
    ...
    override fun toString() =
        "BalanceRetrieveResponse{balanceDue=$balanceDue, creditLimit=$creditLimit, pendingCharges=$pendingCharges, postedCharges=$postedCharges, spendingPower=$spendingPower, additionalProperties=$additionalProperties}"
}
