...
class CompanyRetrieveBalancesResponse
...
private constructor(
    ...
    /** A builder for [CompanyRetrieveBalancesResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(companyRetrieveBalancesResponse: CompanyRetrieveBalancesResponse) =
            apply {
                balanceDue = companyRetrieveBalancesResponse.balanceDue
                creditLimit = companyRetrieveBalancesResponse.creditLimit
                pendingCharges = companyRetrieveBalancesResponse.pendingCharges
                postedCharges = companyRetrieveBalancesResponse.postedCharges
                spendingPower = companyRetrieveBalancesResponse.spendingPower
                additionalProperties =
                    companyRetrieveBalancesResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CompanyRetrieveBalancesResponse].
         *
         ...
         */
        fun build(): CompanyRetrieveBalancesResponse =
            CompanyRetrieveBalancesResponse(
    ...
    fun validate(): CompanyRetrieveBalancesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CompanyRetrieveBalancesResponse &&
    ...
    override fun toString() =
        "CompanyRetrieveBalancesResponse{balanceDue=$balanceDue, creditLimit=$creditLimit, pendingCharges=$pendingCharges, postedCharges=$postedCharges, spendingPower=$spendingPower, additionalProperties=$additionalProperties}"
}
