...
/**
 * This endpoint allows updating a specific transaction by its ID. You can modify the transaction's
 * memo or other editable fields.
 */
...
private constructor(
    ...
    /**
     * A memo or note to attach to the transaction, providing additional information or context
     *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(transactionUpdateParams: TransactionUpdateParams) = apply {
            transactionId = transactionUpdateParams.transactionId
    ...
    override fun toString() =
        "TransactionUpdateParams{transactionId=$transactionId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
