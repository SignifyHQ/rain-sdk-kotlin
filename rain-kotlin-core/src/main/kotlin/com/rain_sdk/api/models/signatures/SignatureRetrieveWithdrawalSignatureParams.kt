...
/**
 * This endpoint retrieves the withdrawal signature for an authorized user tenant. The signature is
 * used to authorize a withdrawal transaction on a blockchain.
 */
...
private constructor(
    ...
    override fun toString() =
        "SignatureRetrieveWithdrawalSignatureParams{token=$token, adminAddress=$adminAddress, amount=$amount, recipientAddress=$recipientAddress, chainId=$chainId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
