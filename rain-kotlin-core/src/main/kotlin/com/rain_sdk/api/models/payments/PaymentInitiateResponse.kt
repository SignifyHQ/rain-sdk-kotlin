...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PaymentInitiateResponse].
         *
    ...
    /** A builder for [PaymentInitiateResponse]. */
    class Builder internal constructor() {

        private var address: JsonField<String>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(paymentInitiateResponse: PaymentInitiateResponse) = apply {
            address = paymentInitiateResponse.address
            additionalProperties = paymentInitiateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PaymentInitiateResponse].
         *
         ...
         */
        fun build(): PaymentInitiateResponse =
    ...
    fun validate(): PaymentInitiateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "PaymentInitiateResponse{address=$address, additionalProperties=$additionalProperties}"
}
