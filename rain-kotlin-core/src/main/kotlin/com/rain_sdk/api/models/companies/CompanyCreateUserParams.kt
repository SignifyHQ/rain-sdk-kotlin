...
/**
 * Creates a new user within a specific company. The user must provide details such as their name,
 * birthdate, and contact information.
 */
class CompanyCreateUserParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CompanyCreateUserParams].
         *
    ...
    /** A builder for [CompanyCreateUserParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(companyCreateUserParams: CompanyCreateUserParams) = apply {
            companyId = companyCreateUserParams.companyId
            body = companyCreateUserParams.body.toBuilder()
            additionalHeaders = companyCreateUserParams.additionalHeaders.toBuilder()
            additionalQueryParams = companyCreateUserParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CompanyCreateUserParams].
         *
         ...
         */
        fun build(): CompanyCreateUserParams =
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{email=$email, firstName=$firstName, isTermsOfServiceAccepted=$isTermsOfServiceAccepted, lastName=$lastName, address=$address, birthDate=$birthDate, phoneCountryCode=$phoneCountryCode, phoneNumber=$phoneNumber, walletAddress=$walletAddress, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CompanyCreateUserParams &&
    ...
    override fun toString() =
        "CompanyCreateUserParams{companyId=$companyId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
