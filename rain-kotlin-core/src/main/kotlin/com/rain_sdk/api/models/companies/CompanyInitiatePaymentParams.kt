...
class CompanyInitiatePaymentParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CompanyInitiatePaymentParams].
         *
    ...
    /** A builder for [CompanyInitiatePaymentParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(companyInitiatePaymentParams: CompanyInitiatePaymentParams) = apply {
            companyId = companyInitiatePaymentParams.companyId
            body = companyInitiatePaymentParams.body.toBuilder()
            additionalHeaders = companyInitiatePaymentParams.additionalHeaders.toBuilder()
            additionalQueryParams = companyInitiatePaymentParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CompanyInitiatePaymentParams].
         *
         ...
         */
        fun build(): CompanyInitiatePaymentParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CompanyInitiatePaymentParams &&
    ...
    override fun toString() =
        "CompanyInitiatePaymentParams{companyId=$companyId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
