...
private constructor(
    ...
    interface Visitor<out T> {
        ...
        fun unknown(json: JsonValue?): T {
            throw RainInvalidDataException("Unknown IssuingTransaction: $json")
        }
    }
        ...
        fun validate(): Spend = apply {
            ...
            _type().let {
                if (it != JsonValue.from("spend")) {
                    throw RainInvalidDataException("'type' is invalid, received $it")
                }
            }
            validated = true
        }
            ...
            class CardType @JsonCreator private constructor(private val value: JsonField<String>) :
                ...
                fun known(): Known =
                    when (this) {
                        ...
                        else -> throw RainInvalidDataException("Unknown CardType: $value")
                    }
