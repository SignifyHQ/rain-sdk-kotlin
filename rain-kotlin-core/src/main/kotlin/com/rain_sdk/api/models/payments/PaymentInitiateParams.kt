...
/**
 * This endpoint initiates a payment for an authorized user tenant. The request includes the amount
 * to be transferred and the wallet address to send the payment from.
 */
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PaymentInitiateParams].
         *
    ...
    /** A builder for [PaymentInitiateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(paymentInitiateParams: PaymentInitiateParams) = apply {
            body = paymentInitiateParams.body.toBuilder()
            additionalHeaders = paymentInitiateParams.additionalHeaders.toBuilder()
            additionalQueryParams = paymentInitiateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PaymentInitiateParams].
         *
         ...
         */
        fun build(): PaymentInitiateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PaymentInitiateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "PaymentInitiateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
