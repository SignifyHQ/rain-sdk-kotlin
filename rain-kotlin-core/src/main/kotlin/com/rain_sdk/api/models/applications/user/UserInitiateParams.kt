 ...
 * personal details of the user, including their first and last name, email address, and optional
 * wallet address if using a Rain-managed solution or hosted completion flow.
 */
class UserInitiateParams
private constructor(
    ...
    /**
     * The user's wallet address. Required if using the hosted completion flow and a Rain-managed
     * solution. Not required otherwise.
     *
     * @throws RainInvalidDataException if the JSON field has an unexpected type (e.g. if the server
     *   responded with an unexpected value).
     */
    ...
    companion object {
        ...
        fun none(): UserInitiateParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [UserInitiateParams]. */
        fun builder() = Builder()
    }

    /** A builder for [UserInitiateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(userInitiateParams: UserInitiateParams) = apply {
            body = userInitiateParams.body.toBuilder()
            additionalHeaders = userInitiateParams.additionalHeaders.toBuilder()
            additionalQueryParams = userInitiateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [UserInitiateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UserInitiateParams =
            UserInitiateParams(
                body.build(),
    ...
    private constructor(
        ...
        ) : this(email, firstName, lastName, walletAddress, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(email, firstName, lastName, walletAddress, additionalProperties.toMutableMap())
        }
        ...
        private val hashCode: Int by lazy {
            Objects.hash(email, firstName, lastName, walletAddress, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{email=$email, firstName=$firstName, lastName=$lastName, walletAddress=$walletAddress, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserInitiateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "UserInitiateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
