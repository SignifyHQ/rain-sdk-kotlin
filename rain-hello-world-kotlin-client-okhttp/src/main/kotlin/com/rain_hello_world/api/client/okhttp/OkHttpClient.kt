...
import com.rain_hello_world.api.core.http.HttpRequestBody
import com.rain_hello_world.api.core.http.HttpResponse
import com.rain_hello_world.api.errors.RainHelloWorldIoException
...
class OkHttpClient private constructor(private val okHttpClient: okhttp3.OkHttpClient) :
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw RainHelloWorldIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("RAIN_HELLO_WORLD_LOG")?.lowercase()) {
