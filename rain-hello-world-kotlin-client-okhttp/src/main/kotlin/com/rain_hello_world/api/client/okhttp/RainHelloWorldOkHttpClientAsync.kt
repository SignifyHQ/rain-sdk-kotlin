...
package com.rain_hello_world.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.rain_hello_world.api.client.RainHelloWorldClientAsync
import com.rain_hello_world.api.client.RainHelloWorldClientAsyncImpl
import com.rain_hello_world.api.core.ClientOptions
import com.rain_hello_world.api.core.Sleeper
import com.rain_hello_world.api.core.Timeout
import com.rain_hello_world.api.core.http.Headers
import com.rain_hello_world.api.core.http.HttpClient
...
/**
 * A class that allows building an instance of [RainHelloWorldClientAsync] with [OkHttpClient] as
 * the underlying [HttpClient].
 */
class RainHelloWorldOkHttpClientAsync private constructor() {

    companion object {

        /**
         * Returns a mutable builder for constructing an instance of [RainHelloWorldClientAsync].
         */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): RainHelloWorldClientAsync = builder().fromEnv().build()
    }

    /** A builder for [RainHelloWorldOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.rain_hello_world.api.core.jsonMapper]. The default is usually sufficient
        ...
        /**
         * Returns an immutable instance of [RainHelloWorldClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RainHelloWorldClientAsync =
            RainHelloWorldClientAsyncImpl(
                clientOptions
                    .httpClient(
