...
import com.rain_hello_world.api.client.RainHelloWorldClientImpl
...
/**
 * A class that allows building an instance of [RainHelloWorldClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class RainHelloWorldOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [RainHelloWorldClient]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): RainHelloWorldClient = builder().fromEnv().build()
    }

    /** A builder for [RainHelloWorldOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [RainHelloWorldClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RainHelloWorldClient =
            RainHelloWorldClientImpl(
                clientOptions
                    .httpClient(
